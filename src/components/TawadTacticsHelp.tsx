...
const faqs = [
  ...
  { question: "Can I use this for buying instead of selling?", answer: "Currently, TawadTactics is designed from the seller's perspective (evaluating a buyer's offer). However, the principles of Game Theory apply to both sides. Future updates may include a dedicated buyer's perspective mode." },
  { question: "What if the buyer's offer is higher than my asking price?", answer: "In a real-world scenario, you would instantly accept it (or double-check if it's a scam). The engine will strongly recommend accepting the offer since the payoff exceeds your expectations." },
  { question: "How accurate is the recommendation?", answer: "The recommendation is mathematically sound based on the inputs you provide. However, human emotions, miscommunication, and external factors cannot be perfectly modeled. Use the recommendation as a strategic guide, not an absolute rule." }
];
